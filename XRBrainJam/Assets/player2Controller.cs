...
public class player2Controller : MonoBehaviour
{
    ...
    public GameObject checkUpObject;
    public GameObject radioFocusObject;
    public GameObject petitionFocusObject;
    public GameObject noisyFocusObject;
    ...
    public GameObject[] heartStatusIcons;
    public GameObject[] soundStatusIcons;
    public GameObject[] focusStatusIcons;
    ...
    void Start()
    {
        ...
        resetStatus();
        heartStatusIcons[2].SetActive(true);
        soundStatusIcons[2].SetActive(true);
        focusStatusIcons[2].SetActive(true);
    ...
    void resetStatus()
    {
        foreach (GameObject heartStat in heartStatusIcons)
        {
            heartStat.SetActive(false);
        }
        foreach (GameObject soundStat in soundStatusIcons)
        {
            soundStat.SetActive(false);
        }
        foreach (GameObject focStat in focusStatusIcons)
        {
            focStat.SetActive(false);
        }
    }
    ...
    void Update()
    {
        ...
        else if (scrCounter == 4 && Input.GetKeyDown(KeyCode.A))
        {
            ...
            resetStatus();
            heartStatusIcons[1].SetActive(true);
            soundStatusIcons[1].SetActive(true);
            focusStatusIcons[2].SetActive(true);
            scrCounter = 5;
        }
        ...
        else if (scrCounter == 6 && Input.GetKeyDown(KeyCode.A))
        {
            ...
            resetStatus();
            heartStatusIcons[1].SetActive(true);
            soundStatusIcons[0].SetActive(true);
            focusStatusIcons[1].SetActive(true);
            scrCounter = 7;
            //RadioVolume
        }
        else if (scrCounter == 7 && Input.GetKeyDown(KeyCode.A))
        {
            ...
            heartStatusIcons[1].SetActive(true);
            soundStatusIcons[0].SetActive(true);
            focusStatusIcons[0].SetActive(true);
            scrCounter = 8;
        }
        ...
        else if (scrCounter == 9 && Input.GetKeyDown(KeyCode.A))
        {
            ...
            // checkUpObject.GetComponent<myInteraction>().activateMyItem();
            scrCounter = 10;
        ...
        else if (scrCounter == 10 && Input.GetKey(KeyCode.A))
        {
            ...
            resetStatus();
            heartStatusIcons[0].SetActive(true);
            soundStatusIcons[0].SetActive(true);
            focusStatusIcons[0].SetActive(true);
        ...
        else if (scrCounter == 12 && checkUpObject.GetComponent<myInteraction>().isCompleted)
        {
        ...
        else if (scrCounter == 13 && Input.GetKeyDown(KeyCode.B))
        {
            if (!audioSource.isPlaying)
            {
                ...
                radioFocusObject.GetComponent<myInteraction>().activateMyItem();
                petitionFocusObject.GetComponent<myInteraction>().activateMyItem();
                noisyFocusObject.GetComponent<myInteraction>().activateMyItem();
                scrCounter = 14;
            }

        }

        else if (scrCounter == 14 && radioFocusObject.GetComponent<myInteraction>().isCompleted)
        {
            if (!audioSource.isPlaying)
            {
                foreach (GameObject speechIcon in speechIcons)
        ...
        else if (scrCounter == 15 && petitionFocusObject.GetComponent<myInteraction>().isCompleted)
        {
            if (!audioSource.isPlaying)
            {
                foreach (GameObject speechIcon in speechIcons)
        ...
        else if (scrCounter == 16 && noisyFocusObject.GetComponent<myInteraction>().isCompleted)
        {
            if (!audioSource.isPlaying)
            {
                foreach (GameObject speechIcon in speechIcons)
        ...
        else if (scrCounter == 17 && Input.GetKeyDown(KeyCode.B))
        {
            if (!audioSource.isPlaying)
            {
